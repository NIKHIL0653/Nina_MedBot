...
const healthContent: HealthContent[] = [
  {
    ...
    description: "Learn how to interpret your blood pressure readings and when to be concerned about hypertension.",
    type: "video",
  ...
  },
  {
    ...
    description: "Expert insights on managing cholesterol levels through diet, exercise, and medication when necessary.",
    type: "article",
  ...
  {
    id: "3",
    title: "Breaking: New Study Shows AI Can Detect Early Signs of Diabetes",
    description: "Researchers demonstrate how machine learning algorithms can identify diabetes risk 5 years before traditional methods.",
    type: "news",
